({
 ...
 doInit : function( component, event, helper ) {
    ...
    //label="{!v.selectedRecord.label}" name="{!v.selectedRecord.value}"
    ...
    console.log("v.label-->",component.get("v.label"));
 ...
 searchRecords : function( component, event, helper ) {
    console.log("searchRecords-->",component.get('v.searchString'));
 ...
 selectItem : function( component, event, helper ) {
        ...
        if(!$A.util.isEmpty(event.currentTarget.id)) {
            ...
            console.log("lookup value-->",component.get('v.value'));
            console.log("lookup selectedRecord-->",component.get('v.selectedRecord'));
